...
const AppMenu = ({ menuItems }: AppMenuProps) => {
  ...
  const [topnavMenuItems, setTopMenuItems] = useState<MenuItemTypes[]>(menuArr);
  ...
  }, [isAdmin, isSuperAdmin, isCompany, isCustomer, isMiddleMan]);
